...
$db['default'] = array(
	'dsn'	=> '',
	'hostname' => 'localhost',
	'username' => 'primefor_main',
	'password' => 'B^wrtSY,mce9',
...
// $db ['default'] ['username'] = 'primefor_main';
// $db ['default'] ['password'] = 'B^wrtSY,mce9';
// $db ['default'] ['database'] = 'primefor_mainsite';
