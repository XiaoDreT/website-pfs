...
class MY_Controller extends CI_Controller {
    ...
    function __init() {
        ...
        define('IMG_PATH_ADMIN', ASSETS_PATH . 'admin/images/');
        ...
        define('UPLOAD_PATH_SLIDE', APPPATH . '../assets/uploads/slider/');
        define('UPLOADED_PATH_SLIDE', ASSETS_PATH . 'uploads/slider/');
    ...
    function is_admin_login() {
        if (!$this->session->userdata('sess-loggedin') && !$this->session->userdata('is_admin')) {
