...
class Home extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['services'] = $this->services->get_data("*", null, 3);
        $this->data['rec_blog'] = $this->article->get_recent_article(6, 0);
        $this->data['product'] = $this->catalogues->get_data("*", array("type" => "unit", "status" => 1), 3);
