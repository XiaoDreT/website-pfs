    ...
    <div class="col-lg-9">
        <div class="panel panel-yellow">
            ...
            <div class="panel-body">
                ...
                ?>
                <form class="form-horizontal" action="<?php echo 'user/update/id/' . $id; ?>" role="form" method="post">
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Full Name</label>
                        <div class="col-lg-8">
                            <input type="text" name="name" class="form-control" placeholder="Input Full Name" value="<?php echo!empty($update) ? $update->name : set_value('name'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Email</label>
                        <div class="col-lg-8">
                            <input type="text" name="email" class="form-control" placeholder="Input Email" value="<?php echo !empty($update) ? $update->email :set_value('email'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Phone</label>
                        <div class="col-lg-4">
                            <input type="text" name="phone" class="form-control" placeholder="Input Phone" value="<?php echo !empty($update) ? $update->phone :set_value('phone'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
