    ...
    <div class="col-lg-9" style="margin-top: 10px">
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <h4>
                    <span>Form Add New Article</span>
                </h4>
            </div>
            <div class="panel-body">
                ...
                ?>
                <form class="form-horizontal" action="<?php echo base_url('admin/article'); ?>/add" role="form" method="post">
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Title</label>
                        <div class="col-lg-10">
                            <input type="text" name="title" class="form-control" placeholder="Input Judul Article" value="<?php echo set_value('title'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="keyword" class="form-control" placeholder="Input Keyword Article" value="<?php echo set_value('keyword'); ?>" /><span>*Dipisahkan dengan tanda koma(,)</span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <input type="text" name="release_date" id="release_date" class="form-control" placeholder="Input Tgl. Tayang" value="<?php echo set_value('release_date'); ?>" />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="image" id="image" class="form-control" placeholder="Input Gambar Article" readonly style="cursor: default;">
