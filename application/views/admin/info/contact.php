    ...
    <div class="col-lg-12">
        <div class="panel panel-blue">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="info" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-1 control-label" for="focus">Google Plus</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="focus">Whatsapp</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" placeholder="Input your Whatsapp link" name="txt_wa" value="<?php echo set_value('txt_wa', $contact['wa']); ?>" />
                        </div>
                        <label class="col-lg-1 control-label" for="focus">Tokopedia</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" placeholder="Input your Tokopedia link" name="txt_tokped" value="<?php echo set_value('txt_tokped', $contact['tokped']); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
