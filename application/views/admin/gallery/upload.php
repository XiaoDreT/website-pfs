                ...
                <?php if (isset($img_target)) { ?>
                    <div class="editcontainer ">
                        ...
                        <div id="form-container">
                            <form id="cropimg" name="cropimg" method="post" action="<?php echo base_url('admin/gallery'); ?>/crop">
                    ...
                    ?> <form class="form-horizontal jc-margin-right" role="form" method="post"
                          action="<?php echo base_url('admin/gallery'); ?>/index"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                2MB, Dimension at least more than (767 x 522) and File Type .jpg, .jpeg, .png
                            </div>
                        </div>
                        <div class="form-group">
