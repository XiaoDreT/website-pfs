        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4>
                    ...
                    <span>Upload Catalogue Image</span>
                </h4>
            </div>
                ...
                <?php if (isset($img_target)) { ?>
                    <div class="editcontainer ">
                        ...
                        <div id="form-container">
                            <form id="cropimg" name="cropimg" method="post" action="<?php echo base_url('admin/gallery'); ?>/crop_catalogue">
                    ...
                    ?> <form class="form-horizontal jc-margin-right" role="form" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                2MB, Dimension at least more than (525 x 525) and File Type .jpg, .jpeg, .png
                            </div>
                        </div>
                        <div class="form-group">
