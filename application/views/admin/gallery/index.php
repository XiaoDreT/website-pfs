                ...
                if (!empty($list_image)) {
                    foreach ($list_image as $row) {
                        ...
                        <div class="col-lg-2">
                            ...
                            <a class="btn btn-default" style="position: absolute; top: 5px; right: 15px; opacity: 0.9" href="<?php echo site_url('admin/gallery/delete/1/' . $row->id); ?>"><span class="icomoon-icon-remove"></span></a>
                        </div>
                        <?php
                    }
                } else {
