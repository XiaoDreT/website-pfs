    ...
    <div class="col-lg-9" style="margin-top: 10px">
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <h4>
                    <span>Form Add New Catalogues</span>
                </h4>
            </div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="catalogues/add" role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="name" class="form-control" placeholder="Input Nama Catalogues" value="<?php echo set_value('name'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="type" value="<?php echo set_value('type'); ?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea id="textarea" rows="8" name="description" class="tinyeditor"><?php echo set_value('description'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="image" id="image" class="form-control" placeholder="Input Gambar Catalogues" readonly style="cursor: default;">
