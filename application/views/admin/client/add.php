            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="<?php echo config_item('localTesting')?>admin/client/add" role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="name" class="form-control" placeholder="Input Nama Client" value="<?php echo set_value('name'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="link" class="form-control" placeholder="Input Link Client" value="<?php echo set_value('link'); ?>" />
                        </div>
                    </div>

                    <div class="form-group">
                        <span class="col-lg-2"></span>
                        <img id="selected_image" src="<?php echo IMG_UPLOADED_MAIN.set_value('image'); ?>" class="img img-width-75 col-lg-10"/>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Gambar</label>
                        <div class="col-lg-10">
                            <input type="text" name="image" id="image" class="form-control" placeholder="Input Gambar Client" value="<?php echo set_value('image'); ?>" readonly style="cursor: default;">
