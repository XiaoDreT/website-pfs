    ...
    <div class="col-lg-9">
        <div class="panel panel-yellow">
            ...
            <div class="panel-body">
                ...
                ?>
                <form class="form-horizontal" action="<?php echo 'services/update/id/' . $id; ?>" role="form" method="post">
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="placeholder">Title</label>
                        <div class="col-lg-10">
                            <input type="text" name="title" class="form-control" readonly="readonly" value="<?php echo set_value('title', $update->name); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="preface">Preface</label>
                        <div class="col-lg-10">
                            <textarea id="textarea" rows="3" name="preface" placeholder="Input Kata Pengantar" class="form-control"><?php echo set_value('preface', $update->preface); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="detail">Detail Services</label>
                        <div class="col-lg-10">
                            <textarea id="textarea" rows="8" name="detail" class="tinyeditor"><?php echo set_value('detail', $update->detail); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="image" id="image" class="form-control" placeholder="Input Gambar Services" value="<?php echo set_value('image', $update->image); ?>" readonly style="cursor: default;">
