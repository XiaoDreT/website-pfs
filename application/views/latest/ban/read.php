...
<div class="inner-page services">
	<div class="container" style="margin-bottom: 20px;">
		<center><h2><? echo $ban->merk; ?></h2></center>
		<div class="row">
			<div class="col-md-5" style="padding: 10px;">
				<img src="<? echo IMG_UPLOADED_MAIN.$ban->image; ?>">
			</div>
			<div class="col-md-7">
				<h4><? echo $ban->name; ?></h4>
				<div class="panelservice">
					<? echo $ban->description; ?>
				</div>
			</div>
		</div>
		<br><br>
		<p style="font-weight: bold; font-size: 20px; text-transform: uppercase;">Ban Forklift Lainnya</p>
		<?php  
		foreach ($related as $val) {
			...
			$link = site_url('latest/ban/read/'.$val->id);
			?>
