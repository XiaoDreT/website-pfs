...
<div class="inner-page services">
	<div class="container" style="margin-bottom: 20px;">
		<center><h2><? echo $sparepart->merk; ?></h2></center>
		<div class="row">
			<div class="col-md-5" style="padding: 10px;">
				<img src="<? echo IMG_UPLOADED_MAIN.$sparepart->image; ?>">
			</div>
			<div class="col-md-7">
				<h4><? echo $sparepart->name; ?></h4>
				<div class="panelservice">
					<? echo $sparepart->description; ?>
				</div>
			</div>
		</div>
		<br><br>
		...
		foreach ($related as $val) {
			...
			$link = site_url('latest/sparepart/read/'.$val->id);
			?>
