...
<div class="inner-page services">
	<div class="container" style="margin-bottom: 20px;">
		<center><h2><? echo $attachment->merk; ?></h2></center>
		<div class="row">
			<div class="col-md-5" style="padding: 10px;">
				<img src="<? echo IMG_UPLOADED_MAIN.$attachment->image; ?>">
			</div>
			<div class="col-md-7">
				<h4><? echo $attachment->name; ?></h4>
		...
		<br><br>
		<p style="font-weight: bold; font-size: 20px; text-transform: uppercase;">Attachment Lainnya</p>
		<?php  
		foreach ($related as $val) {
			...
			$link = site_url('latest/attachment/read/'.$val->id);
			?>
